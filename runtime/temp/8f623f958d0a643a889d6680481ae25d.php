<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"/www/game/public/../application/admin/view/answer_class/index.html";i:1603954273;s:51:"/www/game/application/admin/view/public/header.html";i:1603954267;s:51:"/www/game/application/admin/view/public/footer.html";i:1603954267;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-card">
            ...
            <div class="layui-card-body">
                <?php echo access_button('AnswerClass/add',[],'添加类型'); ?>
                ...
                <table class="layui-table layui-form">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo access_button('AnswerClass/edit', ['id'=>$item['id']], '编辑'); ?>
                            <?php echo access_button('AnswerClass/delete', ['id'=>$item['id']], '删除', 'confirm'); ?>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                    </tbody>
