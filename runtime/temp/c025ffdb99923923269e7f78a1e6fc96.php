<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"/www/game/public/../application/admin/view/data/tanklist.html";i:1603954270;s:51:"/www/game/application/admin/view/public/header.html";i:1603954267;s:51:"/www/game/application/admin/view/public/footer.html";i:1603954267;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="layui-col-md3">
                            ...
                            <div class="layui-input-inline">
                                <select name="tanksid">
                                    ...
                                    <?php foreach($tanks as $key => $vo): if($where['tanksid'] == $vo['id']): ?>
