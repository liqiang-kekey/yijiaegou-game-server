<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"/www/game/public/../application/admin/view/data/userinfo.html";i:1603954270;s:51:"/www/game/application/admin/view/public/header.html";i:1603954267;s:51:"/www/game/application/admin/view/public/footer.html";i:1603954267;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="layui-card-body">
                <form class="layui-search layui-form" action="<?php echo url(userinfo); ?>" method="get">
                    ...
                    <!-- <div class="layui-col-md3">
                        <label>姓名</label>
                        <div class="layui-input-inline">
                            <input type="text" class="layui-input" name="name" value="<?php echo $where['name']; ?>" lay-verify="required" placeholder="名称">
                        </div>
                    </div> -->
