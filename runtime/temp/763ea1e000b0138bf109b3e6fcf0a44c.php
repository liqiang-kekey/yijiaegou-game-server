            ...
            <div class="layui-card-body">
                <form class="layui-search layui-form" action="" method="get">
                    <form class="layui-search layui-form" action="" method="get">
                        ...
                        <div class="layui-col-md3">
                            <label style="color:red;width: 100px;" >总计<?php echo $count; ?>条</label>
                        </div>
