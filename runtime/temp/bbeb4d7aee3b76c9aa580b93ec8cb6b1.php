<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"/www/game/public/../application/admin/view/freetemplate/edit.html";i:1603954269;s:51:"/www/game/application/admin/view/public/header.html";i:1603954267;s:51:"/www/game/application/admin/view/public/footer.html";i:1603954267;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <form class="layui-form padsome" action="">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="name" value="<?php echo $data['name']; ?>" value="" lay-verify="required" placeholder="" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select name="class" lay-verify="required">
                                ...
                                <option value="1" <?php if($data['class'] == 1): ?>selected<?php endif; ?>>家人</option>
                                <option value="2" <?php if($data['class'] == 2): ?>selected<?php endif; ?>>朋友</option>
                                <option value="3" <?php if($data['class'] == 3): ?>selected<?php endif; ?>>同事</option>
                            </select>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="hidden" name="img_after" id="img_after" value="<?php echo $data['img_after']; ?>">
                        </div>
                    </div>

                    <div class="layui-form-item">
                        <label class="layui-form-label">文字图片</label>
                        <div class="layui-input-block">
                            <input type="hidden" name="img_front" id="img_front" value="<?php echo $data['img_front']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea class="layui-textarea" name="content"placeholder="100"> <?php echo $data['content']; ?></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block">
...
<script>
    layui.use(['index', 'form', 'layedit'], function(){
        ...
        uploadInit('img_front', 'image', '图片尺寸 200 * 300');
        uploadInit('img_after', 'image', '图片尺寸 200 * 300');

        // 监听表单提交
        form.on('submit()', function(data){
            delete data.field.file;
            Post("<?php echo url('Freetemplate/edit'); ?>", data.field, function(res) {
                if (res.code == 1) {
