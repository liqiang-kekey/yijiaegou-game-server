<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"/www/game/public/../application/admin/view/game/details.html";i:1603954269;s:51:"/www/game/application/admin/view/public/header.html";i:1603954267;s:51:"/www/game/application/admin/view/public/footer.html";i:1603954267;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <form class="layui-form padsome" action="">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="name" <?php if(!empty($item)): ?> value="<?php echo $item['name']; ?>" <?php endif; ?> lay-verify="required" placeholder="" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">免费、收费开启</label>
                        <div class="layui-input-block">
                            <input type="radio" name="is_vip" value="1" title="启用" <?php if($item['is_vip'] == 1): ?>checked<?php endif; ?>>
                            <input type="radio" name="is_vip" value="0" title="禁用" <?php if($item['is_vip'] == 0): ?>checked<?php endif; ?>>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">鸡蛋警报</label>
                        <div class="layui-input-block">
                            <input type="text" name="alarm_line" <?php if(!empty($item)): ?> value="<?php echo $item['alarm_line']; ?>" <?php endif; ?> lay-verify="required" placeholder="" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">公告</label>
                        <div class="layui-input-block">
                            <textarea class="layui-textarea" name="notice"> <?php if(!empty($item)): ?> <?php echo $item['notice']; endif; ?></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">公告开始时间</label>
                        <div class="layui-input-block">
                            <input type="text" class="layui-input" if(!empty($item)) value="<?php echo $item['logostarttime']; ?>" {/if} id="logostarttime" name="logostarttime">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">公告结束时间</label>
                        <div class="layui-input-block">
                            <input type="text" class="layui-input" if(!empty($item)) value="<?php echo $item['logoendtime']; ?>" {/if} id="logoendtime" name="logoendtime">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block">
...
<script>
    layui.use(['index', 'form', 'layedit','laydate'], function(){
        ...
        var laydate = layui.laydate;
            laydate.render({
                elem: '#logoendtime' //指定元素
                ,type: 'datetime'
            });

            laydate.render({
                elem: '#logostarttime' //指定元素
                ,type: 'datetime'
            })
        // 监听表单提交
