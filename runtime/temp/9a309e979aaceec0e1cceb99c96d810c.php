            ...
            <div class="layui-card-body">
                ...
                <table class="layui-table layui-form">
                    ...
                    <tr>
                        ...
                        <td><?php  echo date('Y-m-d H:i:s' ,$item['last_sign_time']) ;?></td>
                        <!-- <th>操作</th> -->
                    </tr>
                    <?php endforeach; ?>
                    </tbody>
