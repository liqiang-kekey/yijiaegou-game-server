<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"/www/game/public/../application/admin/view/data/user_answer_list.html";i:1603954271;s:51:"/www/game/application/admin/view/public/header.html";i:1603954267;s:51:"/www/game/application/admin/view/public/footer.html";i:1603954267;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="layui-card">
            ...
            <div class="layui-card-body">
                <form class="layui-search layui-form" action="" method="get">
                    <form class="layui-search layui-form" action="<?php echo url(userinfo); ?>" method="get">
                        <div class="layui-col-md3">
                            <label>开始时间</label>
                            <div class="layui-input-inline">
                                <input type="text" class="layui-input" if(!empty($time1)) value="<?php echo $time1; ?>" id="time1" name="time1">
                            </div>
                        </div>
                        <div class="layui-col-md3">
                            <label>结束时间</label>
                            <div class="layui-input-inline">
                                <input type="text" class="layui-input" if(!empty($time2)) value="<?php echo $time2; ?>"  id="time2" name="time2">
                            </div>
                        </div>
                        ...
                        <div class="layui-col-md3">
                            <label>姓名</label>
                            <div class="layui-input-inline">
                                <input type="text" class="layui-input" name="name" value="<?php echo $where['name']; ?>" lay-verify="required" placeholder="输入姓名">
                            </div>
                        </div>
                        <div class="layui-col-md3">
                            <label>微信昵称</label>
                            <div class="layui-input-inline">
                                <input type="text" class="layui-input" name="nickname" value="<?php echo $where['nickname']; ?>" lay-verify="required" placeholder="输入微信昵称">
                            </div>
                        </div>
                        ...
                        <div class="layui-col-md3">
                            <label style="color:red">总计<?php echo $count; ?></label>
                        </div>
                        <div class="layui-clear"></div>
                    </form>
                </form>
                <table class="layui-table layui-form">
                    ...
                    <tr  <?php if(($item['status']==1)): ?>style="color:#1E9FFF" <?php else: ?> style="color:#b5aeae" <?php endif; ?>>
                        <td><?php echo $item['id']; ?></td>
                        <td><?php echo $item['name']; ?></td>
                        <td><?php echo $item['nickname']; ?></td>
                        <td><img src="<?php echo $item['avatar']; ?>"></td>
                        <td><?php echo $item['answer_class_name']; ?></td>
                        <td><?php echo $item['answer_title']; ?></td>
                        <td><?php if(($item['status']==1)): ?>正确<?php else: ?>错误<?php endif; ?></td>
