    ...
    <div class="layui-layout layui-layout-admin">
            ...
            <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect style="margin-right: 30px;">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a lay-href="<?php echo url('Admin/edit_pwd'); ?>">修改密码</a></dd>
                        <!--<hr>-->
            ...
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
                    <li class="layui-nav-item layui-this">
                        <a href="javascript:;" lay-href="<?php echo $home_page; ?>">
                    ...
                    <li data-name="get" class="layui-nav-item">
                        <a href="javascript:;" lay-href="<?php echo url($item['router']); ?>">
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            ...
                            <dd>
                                <a lay-href="<?php echo url($sub_item['router']); ?>"><?php echo $sub_item['name']; ?></a>
                            </dd>
                            <?php endforeach; ?>
                        </dl>
                    </li>
        ...
        <div class="layadmin-pagetabs" id="LAY_app_tabs">
            ...
            <div class="layui-tab" lay-unauto lay-allowClose="true" lay-filter="layadmin-layout-tabs">
                <ul class="layui-tab-title" id="LAY_app_tabsheader">
                    <li lay-id="<?php echo $home_page; ?>" lay-attr="<?php echo $home_page; ?>" class="layui-this"><i class="layui-icon layui-icon-home"></i></li>
                </ul>
            </div>
        </div>
        ...
        <div class="layui-body" id="LAY_app_body">
            <div class="layadmin-tabsbody-item layui-show">
                <iframe src="<?php echo $home_page; ?>" frameborder="0" class="layadmin-iframe"></iframe>
            </div>
        </div>
