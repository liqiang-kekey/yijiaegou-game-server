<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"/www/game/public/../application/admin/view/userparty/index.html";i:1603954265;s:51:"/www/game/application/admin/view/public/header.html";i:1603954267;s:51:"/www/game/application/admin/view/public/footer.html";i:1603954267;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <form class="layui-search layui-form" action="" method="get">
                    <div class="layui-col-md3">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" class="layui-input" value ="<?php echo $where['a']; ?>" name="a" placeholder="输入姓名、昵称"/>
                        </div>
                    </div>
                    <div class="layui-col-md1 layui-search-submit">
                        <div class="layui-input-inline" style="width:200px">
                            <button class="layui-btn layui-btn-normal"  style ="" type="button" onclick="search(this)">
                                搜索
                            </button>
                ...
                <table class="layui-table layui-form">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="<?php echo $item['favatar']; ?>" /></td>
                            <td><?php echo $item['order_sn']; ?></td>
                            <td><?php echo intval($item['proportion']) ;?>%</td>
                            <td><?php echo $item['pay_money']; ?>¥</td>
                            <td><?php echo $item['settlement_money']; ?>¥</td>
...
<script>
    layui.use(['index', 'upload'], function(){
       ...
       $('#execel_out').on('click',()=>{
           ...
           window.location.href = "<?php echo url('admin/Userparty/excel_out'); ?>"+'?a='+name;
       })
   });
</script>