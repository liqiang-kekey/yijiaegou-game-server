<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"/www/game/public/../application/admin/view/goods/add_goods.html";i:1603954269;s:51:"/www/game/application/admin/view/public/header.html";i:1603954267;s:51:"/www/game/application/admin/view/public/footer.html";i:1603954267;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <form class="layui-form padsome" action="">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="sort" value="<?php echo $data['sort']; ?>" lay-verify="required" placeholder="" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">商品类型</label></label>
                        <div class="layui-input-block">
                            <select name="type" lay-verify="required">
                                <option value=""></option>
                                <option value="1" <?php if($data['type'] == 1): ?>selected<?php endif; ?>>优惠券</option>
                                <option value="2" <?php if($data['type'] == 2): ?>selected<?php endif; ?>>实物</option>
                            </select>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">支付类型</label></label>
                        <div class="layui-input-block">
                            <select name="pay_type" lay-verify="required">
                                <option value=""></option>
                                <option value="1" <?php if($data['pay_type'] == 1): ?>selected<?php endif; ?>>积分</option>
                                <option value="2" <?php if($data['pay_type'] == 2): ?>selected<?php endif; ?>>鸡蛋</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="price" value="<?php echo $data['price']; ?>" lay-verify="required" placeholder="" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="stock" value="<?php echo $data['stock']; ?>" lay-verify="required" placeholder="" autocomplete="off" class="layui-input">
                        </div>
                    </div>

                    <div class="layui-form-item">
                        <label class="layui-form-label">是否上架<?php echo $data['shelves']; ?> </label>
                        <div class="layui-input-block">
                            <input type="radio" name="shelves" value="1" title="上架" <?php if($data['shelves'] == 1): ?>checked<?php endif; ?>>
                            <input type="radio" name="shelves" value="2" title="下架" <?php if($data['shelves'] == 2): ?>checked<?php endif; ?>>
                        </div>
                    </div>
                    <div class="layui-form-item">
