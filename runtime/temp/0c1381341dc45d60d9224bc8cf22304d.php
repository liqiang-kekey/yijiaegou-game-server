<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"/www/game/public/../application/admin/view/video/index.html";i:1603954265;s:51:"/www/game/application/admin/view/public/header.html";i:1603954267;s:51:"/www/game/application/admin/view/public/footer.html";i:1603954267;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-card">
            ...
            <div class="layui-card-body">
                <?php echo access_button('Video/add_video'); ?>
                <form class="layui-search layui-form" action="" method="get">
                    <div class="layui-col-md3">
                        <label>搜索名字</label>
                        <div class="layui-input-inline">
                            <input type="text" class="layui-input" name="title" value="<?php echo $where['title']; ?>">
                        </div>
                    </div>
                ...
                <table class="layui-table layui-form">
                    ...
                    <tr>
                        ...
                        <td><video src="<?php echo $item['vurl']; ?>" style="width: 60px;"></video></td>
                        <td>
                            <!--操作按钮开始-->
                            <?php echo access_button('Video/edit_video', ['id'=>$item['id']], '编辑'); ?>
                            <?php echo access_button('Video/del_video', ['id'=>$item['id']], '删除', 'confirm'); ?>
                            <!--操作按钮结束-->
                        </td>
                    </tr>
                    <?php endforeach; ?>
