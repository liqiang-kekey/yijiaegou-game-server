<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"/www/game/public/../application/admin/view/commissionsharp/index.html";i:1603346411;s:51:"/www/game/application/admin/view/public/header.html";i:1603346408;s:51:"/www/game/application/admin/view/public/footer.html";i:1603346407;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <form class="layui-form padsome" action="">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="" value="" lay-verify="required" placeholder="请输入百分比" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block">
