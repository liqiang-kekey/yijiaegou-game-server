<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"/www/game/public/../application/admin/view/tanksluck/index.html";i:1603954266;s:51:"/www/game/application/admin/view/public/header.html";i:1603954267;s:51:"/www/game/application/admin/view/public/footer.html";i:1603954267;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-card">
            ...
            <div class="layui-card-body">
                <?php echo access_button('Tanksluck/add'); ?>
                ...
                <table class="layui-table layui-form">
                    ...
                    <tr>
                        ...
                        <td><?php if(($item['type'] == 1)): ?> 积分<?php elseif(($item['type'] == 2)): ?>鸡蛋 <?php else: ?> 优惠券<?php endif; ?></td>
                        <td><?php echo $item['number']; ?></td>
                        <td>
                            <?php echo access_button('Tanksluck/edit', ['id'=>$item['id']], '编辑'); ?>
                            <?php echo access_button('Tanksluck/delete', ['id'=>$item['id']], '删除', 'confirm'); ?>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                    </tbody>
