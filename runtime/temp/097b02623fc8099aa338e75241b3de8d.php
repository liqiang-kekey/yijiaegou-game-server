<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"/www/game/public/../application/admin/view/base/admin_menu/index.html";i:1603954272;s:51:"/www/game/application/admin/view/public/header.html";i:1603954267;s:51:"/www/game/application/admin/view/public/footer.html";i:1603954267;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-card">
            ...
            <div class="layui-card-body">
                <?php echo access_button('AdminMenu/add_menu'); ?>
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo access_button('AdminMenu/edit_menu', ['id'=>$item['id']], '编辑'); ?>
                            <?php echo access_button('AdminMenu/del_menu', ['id'=>$item['id']], '删除', 'confirm'); ?>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                    </tbody>
