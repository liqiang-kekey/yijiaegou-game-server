<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"/www/game/public/../application/admin/view/sigin/index.html";i:1603954267;s:51:"/www/game/application/admin/view/public/header.html";i:1603954267;s:51:"/www/game/application/admin/view/public/footer.html";i:1603954267;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-card">
            ...
            <div class="layui-card-body">
                <?php echo access_button('Sigin/add_sigin'); ?>
                ...
                <table class="layui-table layui-form">
                    ...
                    <tr>
                        ...
                        <td><?php echo $item['rulename']; ?></td>
                        <td><?php echo $item['ruleday']; ?></td>
                        <td><?php echo $item['isenable']; ?></td>
                        <td><?php echo $item['name']; ?></td>
                        <td>
                            <!--操作按钮开始-->
                            <?php echo access_button('Sigin/edit_sigin', ['id'=>$item['id']], '编辑'); ?>
                            <?php echo access_button('Sigin/del_sigin', ['id'=>$item['id']], '删除', 'confirm'); ?>
                            <!--操作按钮结束-->
                        </td>
                    </tr>
                    <?php endforeach; ?>
