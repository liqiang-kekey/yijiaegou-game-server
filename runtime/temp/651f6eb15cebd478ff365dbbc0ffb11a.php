<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"/www/game/public/../application/admin/view/data/integral.html";i:1603954270;s:51:"/www/game/application/admin/view/public/header.html";i:1603954267;s:51:"/www/game/application/admin/view/public/footer.html";i:1603954267;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="layui-card-body">
                <form class="layui-search layui-form" action="" method="get">
                        ...
                        <div class="layui-col-md3">
                            <label>姓名</label>
                            <div class="layui-input-inline">
                                <input type="text" class="layui-input" name="name" value="<?php echo $where['name']; ?>" lay-verify="required" placeholder="姓名">
                            </div>
                        </div>
                        ...
                        <div class="layui-col-md3">
                            ...
                            <div class="layui-input-inline">
                                <select name="type">
                                    ...
                                    <option value ="1" <?php if($where['type']==1): ?> selected="selected" <?php endif; ?>>积分</option>
                                    <option value ="2" <?php if($where['type']==2): ?> selected="selected" <?php endif; ?>>优惠券</option>
                                </select>
                            </div>
                        </div>
                ...
                <table class="layui-table layui-form">
                    ...
                    <tr>
                        ...
                        <td><?php echo $v['integral']; ?></td>
                         <!-- 新增-->
                        <td><?php echo $v['egg']; ?></td>
                        <!-- 结束-->
                        <td><?php echo $v['zrintegral']; ?></td>
                        <td><?php if($v['type'] == 1): ?>积分转入<?php elseif($v['type'] == 2): ?>优惠券转入<?php else: ?>其他<?php endif; ?></td>
                        <td><?php if($v['status'] == 1): ?>成功<?php else: ?><span style ="color: red;">失败</span><?php endif; ?></td>
