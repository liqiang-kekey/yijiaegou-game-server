<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"/www/game/public/../application/admin/view/task_goods/index.html";i:1603954266;s:51:"/www/game/application/admin/view/public/header.html";i:1603954267;s:51:"/www/game/application/admin/view/public/footer.html";i:1603954267;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-card">
            ...
            <div class="layui-card-body">
                <?php echo access_button('TaskGoods/add_taskgoods'); ?>
                ...
                <table class="layui-table layui-form">
                    ...
                    <tr>
                        ...
                        <td><?php echo $item['asc']; ?></td>
                        <td>
                            <!--操作按钮开始-->
                            <?php echo access_button('TaskGoods/edit_taskgoods', ['id'=>$item['id']], '编辑'); ?>
                            <?php echo access_button('TaskGoods/del_taskgoods', ['id'=>$item['id']], '删除', 'confirm'); ?>
                            <!--操作按钮结束-->
                        </td>
                    </tr>
                    <?php endforeach; ?>
