<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"/www/game/public/../application/admin/view/task/add_task.html";i:1603954266;s:51:"/www/game/application/admin/view/public/header.html";i:1603954267;s:51:"/www/game/application/admin/view/public/footer.html";i:1603954267;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select name="class" lay-verify="required" lay-filter="cls">
                                <option value=""></option>
                                <option value="1" <?php if($data['class'] == 1): ?>selected<?php endif; ?>>每日签到</option>
                                <option value="2" <?php if($data['class'] == 2): ?>selected<?php endif; ?>>一键喂养</option>
                                ...
                                <option value="5" <?php if($data['class'] == 5): ?>selected<?php endif; ?>>分享游戏</option>
                                <option value="10" <?php if($data['class'] == 10): ?>selected<?php endif; ?>>观看溯源视频</option>
