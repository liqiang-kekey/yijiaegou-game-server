<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"/www/game/public/../application/admin/view/outcart/deliver.html";i:1603954268;s:51:"/www/game/application/admin/view/public/header.html";i:1603954267;s:51:"/www/game/application/admin/view/public/footer.html";i:1603954267;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <form class="layui-form padsome" action="">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="shipping_order" value="" lay-verify="required" placeholder="" autocomplete="off" class="layui-input">
                        </div>
                        <input type ="hidden" name ="id" value ="<?php echo $id; ?>" >
                        <div class="layui-input-block layui-form-intro">
                            <div class="layui-form-mid layui-word-aux">请填写配送单号</div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block">
            ...
            Post('', data.field, function(res) {
                if (res.code == 1) {
                    alert_success(res.msg, function() {
                        window.location.href = "<?php echo url('Outcart/index'); ?>";
                    })
                } else {
                    alert_error(res.msg);
                }
