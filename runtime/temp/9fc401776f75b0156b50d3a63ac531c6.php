<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"/www/game/public/../application/admin/view/sys_video/index.html";i:1603954266;s:51:"/www/game/application/admin/view/public/header.html";i:1603954267;s:51:"/www/game/application/admin/view/public/footer.html";i:1603954267;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-card">
            ...
            <div class="layui-card-body">
                <form class="layui-form padsome" action="index">
                    <div class="layui-form-item">
                        <label class="layui-form-label">账号：</label>
                        <div class="layui-input-block">
                            <input type="text" name="uname" value="<?php echo $data['uname']; ?>"  placeholder="" autocomplete="off" class="layui-input">
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="upwd" value="<?php echo $data['upwd']; ?>"  placeholder="" autocomplete="off" class="layui-input">
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="channelname" value="<?php echo $data['channelname']; ?>"  placeholder="" autocomplete="off" class="layui-input">
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="url" value="<?php echo $data['url']; ?>" lay-verify="required" placeholder="" autocomplete="off" class="layui-input">
                        </div>
...
<script>
    layui.use(['index', 'form', 'layedit'], function(){
        ...
        uploadInit('image', 'image', '图片尺寸 200 * 300');
