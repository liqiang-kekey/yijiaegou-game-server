<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"/www/game/public/../application/admin/view/goods/index.html";i:1603954269;s:51:"/www/game/application/admin/view/public/header.html";i:1603954267;s:51:"/www/game/application/admin/view/public/footer.html";i:1603954267;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="layui-card-body">
                ...
                <table class="layui-table layui-form">
                    ...
                    <tr>
                        ...
                        <td><?php if($item['type'] == 1): ?>优惠券<?php elseif($item['type'] == 2): ?>实物<?php else: ?>未知类型<?php endif; ?></td>
                        <td><?php if($item['pay_type'] == 1): ?>积分<?php elseif($item['pay_type'] == 2): ?>鸡蛋<?php else: ?>未知方式<?php endif; ?></td>
                        <td><?php echo $item['price']; ?></td>
                        <td><?php echo $item['stock']; ?></td>
                        <td><?php if($item['shelves'] == 1): ?>上架<?php elseif($item['shelves'] == 2): ?>下架<?php else: ?>无状态<?php endif; ?></td>
                        <td>
                            <!--操作按钮开始-->
