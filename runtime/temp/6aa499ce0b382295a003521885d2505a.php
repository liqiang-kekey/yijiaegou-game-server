<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"/www/game/public/../application/admin/view/answer_class/edit.html";i:1603954273;s:51:"/www/game/application/admin/view/public/header.html";i:1603954267;s:51:"/www/game/application/admin/view/public/footer.html";i:1603954267;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="layui-card-body">
                <form class="layui-form padsome" action="">
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">趣味类型</label>
                        <div class="layui-input-block">
                            <input type="text" name="name" value="<?php echo $item['name']; ?>" lay-verify="required" placeholder="请输入类型名称" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block">
...
<script>
    layui.use(['index', 'form', 'layedit'], function(){
        ...
        form.on('submit()', function(data){
            ...
            Post("<?php echo url('admin/AnswerClass/edit'); ?>", data.field, function(res) {
                if (res.code == 1) {
