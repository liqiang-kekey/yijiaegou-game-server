<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"/www/game/public/../application/admin/view/data/chickdata.html";i:1603954270;s:51:"/www/game/application/admin/view/public/header.html";i:1603954267;s:51:"/www/game/application/admin/view/public/footer.html";i:1603954267;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="layui-card-body">
                <form class="layui-search layui-form" action="" method="get">
                    ...
                    <div class="layui-col-md3">
                        <label>小鸡等级</label>
                        <div class="layui-input-inline">
                            <input type="text" class="layui-input" name="grade" value="<?php echo $where['grade']; ?>" lay-verify="required" placeholder="小鸡等级">
                        </div>
                    </div>
                ...
                <table class="layui-table layui-form">
                    ...
                    <tr>
                        ...
                        <td><?php if($item['level'] == 1): ?>孵化期<?php elseif($item['level'] == 2): ?>成长期<?php elseif($item['level'] == 3): ?>产蛋期<?php else: ?>出栏期<?php endif; ?></td>
